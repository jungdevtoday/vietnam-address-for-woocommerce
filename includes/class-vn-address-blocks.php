...
class VN_Address_Blocks {
    ...
    public function register_fields() {
        ...
        woocommerce_register_additional_checkout_field(array(
            'id' => self::FIELD_WARD,
            'label' => __('Ward/Commune', 'onestudio-vietnam-address-for-woocommerce'),
            'location' => 'address',
            'type' => 'text',
            'required' => true,
        ));
        ...
        woocommerce_register_additional_checkout_field(array(
            ...
            'label' => __('Ward code', 'onestudio-vietnam-address-for-woocommerce'),
            'location' => 'address',
            'type' => 'text',
            'required' => true,
        ));
    ...
    public function validate_address_fields(\WP_Error $errors, $fields) {
        ...
        if (empty($ward_name)) {
            $errors->add(
                ...
                __('Please select a valid Ward/Commune from the list for the chosen Province/City.', 'onestudio-vietnam-address-for-woocommerce')
            );
        }
    }
    ...
    public function enqueue_scripts() {
        ...
        wp_localize_script('vn-address-checkout-blocks-js', 'vnAddressBlocks', array(
            ...
            'i18n' => array(
                'selectProvinceFirst' => __('Select a Province/City first', 'onestudio-vietnam-address-for-woocommerce'),
                'noResults' => __('No matches found', 'onestudio-vietnam-address-for-woocommerce'),
            ),
        ));
    }
